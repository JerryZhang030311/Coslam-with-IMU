...
'''
    in the first frame, we optimize the iposenet and the oposenet altogether, with 100-150 iterations
    for the latter frames, we only optimize oposenet, assuming the intrinsic changes slowly.
    for each 50 or more steps, we optimize iposenet again.
    after all the training, we optimize the 2 posenets altogether with the poses saved in the former training.
'''
